...
const Register = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[100dvh] pb-10 bg-black relative overflow-hidden">
            {/* Background Decoration */}
            <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] pointer-events-none animate-pulse-slow"></div>
            ...
            <div className="w-full max-w-md p-8 bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl relative z-10">
                <div className="text-center mb-8">
                    <h2 className="text-4xl font-black text-white tracking-tighter mb-2">Join the Squad</h2>
                    <p className="text-gray-400 text-sm font-medium">Create your profile and find your gym buddy today.</p>
                </div>
                ...
                <form onSubmit={submitHandler} className="space-y-5">
                    <div>
                        <label className="block mb-2 text-xs font-bold text-gray-500 uppercase tracking-widest">Full Name</label>
                        <input
                            type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block mb-2 text-xs font-bold text-gray-500 uppercase tracking-widest">Confirm</label>
                            <input
                                type="password"
                                className="w-full p-4 text-white bg-black/40 border border-gray-700 rounded-xl focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/50 transition-all font-medium placeholder-gray-600"
                ...
                <div className="mt-8 text-center border-t border-gray-800 pt-6">
                    ...
                    <Link to="/login" className="font-bold text-primary hover:text-white transition-colors ml-1">
                        Sign In
                    </Link>
                </div>
            </div>
